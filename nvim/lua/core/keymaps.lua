...
keymap("v", "L", "$h", { desc = "选中跳行尾" })

-- ==========================================
-- 删除到行尾/行首 
-- ==========================================
-- 映射 dL 为 d$ (删除从光标处到行尾的所有内容)
keymap('n', 'dL', 'd$', { noremap = true, desc = 'Delete to end of line' })
-- 映射 dH 为 d^ (删除从光标处到行首第一个非空字符的内容，适合写代码)
keymap('n', 'dH', 'd^', { noremap = true, desc = 'Delete to start of line (non-blank)' })
